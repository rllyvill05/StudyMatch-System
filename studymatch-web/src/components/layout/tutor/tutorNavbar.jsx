  ...
  return (
    <>
      <style>{`
        ...
        .tn-search:focus-within { border-color: #7C3AED; background: white; }
        .tn-search input {
          border: none; background: transparent; outline: none;
          font-size: 13.5px; color: #374151; width: 100%;
          font-family: 'DM Sans', sans-serif;
        }
        .tn-search input::placeholder { color: #9CA3AF; }
      `}</style>

      <header className="tn-bar">
        <div className="tn-search">
          <Search size={15} color="#9CA3AF" />
          <input placeholder="Search students, subjects, goals..." />
        </div>
        <div style={{ flex: 1 }} />
